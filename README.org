This fork is designed to work within OpenFrameworks projects. json.hpp has been removed as it is included within OpenFrameworks as ofJson. EasyLogging has been removed to instead use OF's own logging.
